...
const StatusBadge = ({ status }: { status: string }) => {
  ...
  return (
    <Badge variant="outline" className={`${colors[status as keyof typeof colors]} ml-auto`}>
      ...
      <div className="flex-1 w-full">
        <div className="flex gap-4 w-full h-[calc(100vh-3.5rem)]">
          ...
          <div className="w-[65%] p-6 space-y-6">
            ...
            <Card className="shadow-sm">
              <CardHeader className="border-b bg-gradient-to-r from-blue-50 to-white py-4">
                <CardTitle className="text-blue-800">Treatment Progress</CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="flex flex-col p-4 bg-blue-50 rounded-lg border border-blue-100">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="font-semibold text-blue-800">Laboratory</h3>
                    </div>
                  ...
                  <div className="flex flex-col p-4 bg-blue-50 rounded-lg border border-blue-100">
                    ...
                    <StatusBadge status={patient.status.investigations.imaging} />
                  </div>
                </div>
              </CardContent>
            </Card>
